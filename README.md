...
see [PLAN.md](./PLAN.md) for the full delivery plan. current progress:

- [x] phase 0 — architecture locked
- [x] phase 1 — backend foundation
- [x] phase 2 — admin portal and central dashboard
- [x] phase 3 — workstation runtime
- [ ] phase 4 — tablet app
